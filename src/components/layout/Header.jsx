                ...
                <div className="grid grid-cols-7 gap-1 px-4 pb-5 flex-1 overflow-y-auto">
                    ...
                    {Array.from({ length: daysInMonth }).map((_, i) => {
                        ...
                        return (
                            <div
                                key={day}
                                className={`min-h-[88px] rounded-2xl p-2 flex flex-col gap-1 border transition-colors ${
                                    isToday
                            ...
                            >
                                <span className={`text-xs font-bold self-end w-6 h-6 flex items-center justify-center rounded-full flex-shrink-0 ${
                                    isToday ? 'bg-[#5030E5] text-white' : 'text-slate-400'
                                }`}>
                                    {day}
                                </span>
